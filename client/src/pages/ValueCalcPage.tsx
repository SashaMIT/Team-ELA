...
const ValueCalcPage = () => {
  ...
  const elaSupply = (hashrateData?.elastosCirculatingSupply ?? 26220000) / 1000000; // Convert to millions
          ...
          <div className="space-y-4 sm:space-y-8 px-2 sm:px-0">
            ...
            <div className="flex flex-col sm:grid sm:grid-cols-2 gap-3 sm:gap-2 mb-4 sm:mb-6 px-2 sm:px-0">
              ...
              <Dialog>
                ...
                <DialogContent 
                  className="w-full sm:max-w-4xl p-2 sm:p-4 md:p-6 overflow-y-auto max-h-[90vh] backdrop-blur-sm"
