...
const NetworkSphere: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      orangeSphereRef.current = new NetworkSphereClass(centerX, 'rgba(204, 85, 0, 1)', canvas.width * 0.24, 2400);
      blackSphereRef.current = new NetworkSphereClass(centerX2, 'rgba(0, 0, 0, 1)', canvas.width * 0.192, 2000);
    };
    ...
    // Initialize spheres
    orangeSphereRef.current = new NetworkSphereClass(180, 'rgba(204, 85, 0, 1)', 384, 2400);
    blackSphereRef.current = new NetworkSphereClass(520, 'rgba(0, 0, 0, 1)', 154, 2000);
