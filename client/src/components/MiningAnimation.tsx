...
const MiningAnimation = () => {
  ...
  return (
    <Card className="p-3 sm:p-4 bg-gray-50 max-w-full overflow-hidden">
      <div className="space-y-3">
        ...
        <div className={`font-mono text-[0.7rem] sm:text-sm ${foundValid ? 'bg-green-100' : 'bg-white'} 
          p-2 rounded flex flex-wrap transition-colors duration-300`}>
